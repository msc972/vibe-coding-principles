...
- **Documentation** (the Markdown files: the two standards docs, this README,
  and CONTRIBUTING) is licensed under [CC BY 4.0](LICENSE).
- **Code** (the hook scripts, tests, and configuration) is licensed under the
  [MIT License](LICENSE-CODE).

Attribution to msc972.
